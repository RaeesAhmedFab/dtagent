  ...
  return (
    <div className="max-w-[740px]">
      ...
      <div className="bg-blue-50 border-l-4 border-blue-400 rounded-r-xl px-5 py-4 mb-5">
        ...
        <p className="text-[14px] text-gray-700 leading-relaxed">{article.desc}</p>
      </div>
      ...
      <div className="border border-gray-200 rounded-xl p-4 mb-5 flex items-start gap-2.5">
        ...
        <p className="text-[13px] text-gray-600 leading-relaxed">
          <span className="font-semibold">Why we don't host the full article</span>
          {" "}DTAgent provides AI-generated summaries only. Full article text remains with the
          original publisher to respect copyright. Tap "Read original" to view the complete
          piece on {article.source}.
        </p>
      </div>

      {/* CTA buttons */}
      <div className="flex items-center gap-3 mb-8 flex-wrap">
        <Button  className="inline-flex items-center gap-2 hover:bg-[#163d72] cursor-pointer ">
          <ExternalLink size={13} /> Read full article on {article.source}
        </Button>
        <Button onClick={handleOpenAskAgent}  variant="outline" className="inline-flex items-center gap-2 border border-gray-200 hover:border-[#163d72] cursor-pointer ">
