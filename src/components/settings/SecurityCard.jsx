...
const SecurityCard = ({ 
  requireYmSso, 
  setRequireYmSso, 
  useYmAdminPermissions, 
  setUseYmAdminPermissions, 
  sanitizeAgentInputs, 
  setSanitizeAgentInputs, 
  enforceHttps, 
  setEnforceHttps 
}) => {
  return (
    <SettingsCard title="Security & access" badge="AU-02 · AU-08 · NF-08–12">
      <div className="space-y-0 divide-y">
        <ToggleRow
          ...
          checked={requireYmSso}
          onChange={setRequireYmSso}
        />
        ...
        <ToggleRow
          ...
          checked={useYmAdminPermissions}
          onChange={setUseYmAdminPermissions}
        />
        ...
        <ToggleRow
          ...
          checked={sanitizeAgentInputs}
          onChange={setSanitizeAgentInputs}
        />
